...
public class DK extends javax.swing.JFrame {
    ...
    private void showData(List<Account> list) {
    ...
    private Account getToForm() {
        ...
        if (!gmail.matches("[^@]{2,64}@[^.]{2,253}\\.[0-9a-z-.]{2,63}")) {
            JOptionPane.showMessageDialog(this, "Gmail không đúng định dạng");
            return null;
        }
        if (user.length() < 8 || user.length() > 20) {
            JOptionPane.showMessageDialog(this, "Username phải từ 8 => 12 ký tự");
            return null;
        }
//        if (!user.matches("[a-z A-Z 0-9]")) {
//            JOptionPane.showMessageDialog(this, "User không chứa kí tự đặng biệt");
//            return null;
//        }
        if (pass.length() < 8) {
            JOptionPane.showMessageDialog(rootPane, "Độ dài password phải hơn 8 kia tự");
            return null;
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("We will help you create an account!");
        ...
        jPanel2.add(labelLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 410, 40, 22));
        ...
        jPanel2.add(btnSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 360, 209, 35));
        ...
        jLabel13.setText("I've an account");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 410, 80, 22));
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        if (getToForm() == null) {
            ...
            service.insert(getToForm());
            JOptionPane.showMessageDialog(this, "Đăng ký thành công");
            int check = JOptionPane.showConfirmDialog(this, "BẠN CÓ MUỐN ĐĂNG NHẬP NGAY KHÔNG?", "ĐỀ XUẤT", 2);
